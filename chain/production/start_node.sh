...
# Shard 0
if [ "$1" == "shard0-0" ]; then
INCOGNITO_NETWORK_KEY=testnet ./incognito --discoverpeersaddress "0.0.0.0:9330" --miningkeys "112t8rnX5AVkpTZtBo97KdyuDavCtufutWu8tBdDvt6D4WvULd4yyQtiVACadFdDZ28XTGgdfHkmf7wKY9iHo5gsKGwS" --nodemode "auto" --datadir "data/shard0-0" --listen "0.0.0.0:9434" --externaladdress "0.0.0.0:9434" --norpcauth --rpclisten "0.0.0.0:9334" --loglevel debug
fi
if [ "$1" == "shard0-1" ]; then
INCOGNITO_NETWORK_KEY=testnet ./incognito --discoverpeersaddress "0.0.0.0:9330" --miningkeys "112t8rnXUiPCmJ19QxbmyVYvbTPM6UcN6aJZ95mgWmb1tVGexMn6BXNHAdtK1bMP4aTspD8EcmPPJhUyc66jLBmuG4ck" --nodemode "auto" --datadir "data/shard0-1" --listen "0.0.0.0:9435" --externaladdress "0.0.0.0:9435" --norpcauth --rpclisten "0.0.0.0:9335" --loglevel debug
fi
if [ "$1" == "shard0-2" ]; then
