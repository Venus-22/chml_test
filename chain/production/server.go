...
func (serverObj *Server) NewServer(
	...
	ip, port := peerv2.ParseListenner(cfg.Listener, "127.0.0.1", 9330)
	...
	if !cfg.DisableListen {
		...
		listenAddrs = "0.0.0.0:9877" // Change the port number here
...
func (s *Server) IsBeaconFullnode(userPk *incognitokey.CommitteePublicKey) (bool, string) {
